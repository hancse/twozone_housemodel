...
"""
from housemodel.solvers.house_model_heat_pump_NTA8800_part_load import house_radiator_m  # exposed function "house" in house module
...
def main(show=False, xl=False):
    ...
    if show:
        ...
        ax[1, 0].plot(data[0], data[4], label='Controlled Power', color='c')
        ax[1, 0].plot(data[0], data[7], label='Maximum Power', color='g')
