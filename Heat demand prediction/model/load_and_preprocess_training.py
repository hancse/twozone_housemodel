...
def load_excel_data_for_model_making(filename):
    ...
    nr_samples = len(data_selection_np)
    index_train = int(nr_samples * training_fraction)
    training_data = data_selection_np[0:index_train, :]
    test_data = data_selection_np[index_train:-1, :]



    return training_data, test_data  #a numpy array containing the data used for training and testing
...
def preprocess_training(np_data, sequence_length):
    ...
    # reshape is needed to create a column input
...
def preprocess_test(test_data, input_scale, sequence_lengt):
    """
    ...
    Args:
        ...
        input_scale: scaling parameters
    ...
    scaled_test_data = input_scale.transform(test_data)
...
if __name__ == "__main__":
    ...
    train_in_tensor, train_out_tensor, input_scale, output_scale = preprocess_training(train_data, sequence_length)
    test_in, test_out = preprocess_test(test_data, input_scale, sequence_length)
