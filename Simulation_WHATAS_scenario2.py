...
"""
from housemodel.solvers.Apartment_model_WHATAS_scenario2 import house_radiator_m  # exposed function "house" in house module
...
def main(show=False, xl=False):
    ...
    if show:
        ...
        ax[1, 1].plot(data[0], data[12] / 1000, label='Power middel vessel', color='r')
        ax[1, 1].plot(data[0], data[13] / 1000, label='Power lower vessel', color='g')
        ax[1, 1].plot(data[0], data[14] / 1000, label='Total power', color='y')
        ...
        ax[0, 1].plot(data[0], data[8], label='Top middle')
        ax[0, 1].plot(data[0], data[9], label='Bottom middle')
        ax[0, 1].plot(data[0], data[10], label='Top lower')
        ax[0, 1].plot(data[0], data[11], label='Bottom lower')
