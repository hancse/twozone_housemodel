...
def house_radiator_m(cap_mat_inv, cond_mat, q_vector,
    ...
    Twall0 = 20
    TBuffervessel0 = 70
    TBuffervessel20 = 62.5
    TBuffervessel30 = 50
    TBuffervessel80 = 62.5
    ...
    y0buffervessel2 = [TBuffervessel20, TBuffervessel20, TBuffervessel20, TBuffervessel20, TBuffervessel20, TBuffervessel20,
                      TBuffervessel20, TBuffervessel20]
    y0buffervessel3 = [TBuffervessel30, TBuffervessel30, TBuffervessel30, TBuffervessel30, TBuffervessel30, TBuffervessel30,
                      TBuffervessel30, TBuffervessel30]
    ...
    Tmiddlevessel1 = np.ones(len(t)) * 62.5
    Tmiddlevessel8 = np.ones(len(t)) * 50

    Tlowervessel1 = np.ones(len(t)) * 50
    Tlowervessel8 = np.ones(len(t)) * 40
    ...
    # Flow controller Highest buffervessel
    ...
    for i in range(len(t)-1):
        ...
        inputs_buffervessel = (75, Tmiddlevessel1[i], mdots, total_flow)
        result_buffervessel = solve_ivp(sb.model_stratified_buffervessel, ts, y0buffervessel, method='RK45', args=inputs_buffervessel,
                        first_step=control_interval)

        inputs_buffervessel2 = (62.5, Tlowervessel1[i], mdots2, total_flow)
        result_buffervessel2 = solve_ivp(sb2.model_stratified_buffervessel, ts, y0buffervessel2, method='RK45',
                                        args=inputs_buffervessel2,
                                        first_step=control_interval)

        inputs_buffervessel3 = (50, combined_return_temperature, mdots3, total_flow)
        result_buffervessel3 = solve_ivp(sb3.model_stratified_buffervessel, ts, y0buffervessel3, method='RK45',
                                        args=inputs_buffervessel3,
                                        first_step=control_interval)
        ...
        Tmiddlevessel1[i + 1] = result_buffervessel2.y[0, -1]
        Tmiddlevessel8[i + 1] = result_buffervessel2.y[7, -1]

        Tlowervessel1[i + 1] = result_buffervessel3.y[0, -1]
        Tlowervessel8[i + 1] = result_buffervessel3.y[7, -1]
