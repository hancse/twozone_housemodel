...
"""
from housemodel.solvers.house_radiator_matrix_for_loop import house_radiator_m  # exposed function "house" in house module
...
def main(show=False):
    ...
    if show:
        ...
        plt.legend(loc='best')
        plt.title("Simulation2R2C_radiator_matrix")
        plt.show()
