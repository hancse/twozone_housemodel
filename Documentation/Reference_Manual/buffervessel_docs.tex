...
\begin{figure}[H]
	\centering
	\subfloat[\centering paper results]{{\includegraphics[width=0.7\columnwidth]{Pictures/paper_results.jpg} }}
	\qquad
	\subfloat[\centering Python results]{{\includegraphics[width=0.8\columnwidth]{Pictures/Python_validation_graph_buffervessel.png} }}
