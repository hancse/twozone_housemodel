...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\columnwidth]{Figures/House_electrical_circuits overview.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\columnwidth]{Figures/2_Zones_house_circuits.png}
