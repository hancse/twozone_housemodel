...
\lstinputlisting[label=lst:capnode, linerange={9-14}, 
caption={Capacitor Node}] 
...
\lstinputlisting[label=lst:capnode, linerange={17-22}, 
caption={Fixed Node}] 
{../../housemodel/buildings/components.py}
...
\lstinputlisting[label=lst:capnode, linerange={25-31}, 
...
\lstinputlisting[label=lst:capnode, linerange={34-40}, 
caption={Flow Edges}] 
{../../housemodel/buildings/components.py}
